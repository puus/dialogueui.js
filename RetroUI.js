...
var Box = (function () {
    function Box(id, width, height, flavour) {
        this.id = id;
        this.width = width;
        this.height = height;
    ...
    Box.prototype.initCss = function () {
        ...
        var cssSectionRule = "#" + this.id + " {" + "display: block;" + "width: " + this.width + "em;" + "height: " + this.height + "em;} ";
        var cssBorderRule = "#" + this.id + " .border1 {" + "width: " + this.borderWidth + "em;" + "height: " + this.borderHeight + "em;} ";
        var cssContentRule = "#" + this.id + " .content {" + "width: " + this.contentWidth + "em;" + "height: " + this.contentHeight + "em;} ";
        var cssHiddenRule = "#" + this.id + " {" + "display: none;" + "}";
        var strCombinedRule = "";
        if(this.hidden == true) {
...
var DisplayBox = (function (_super) {
    ...
    function DisplayBox(id, width, height, flavour, text) {
        this.text = text;
        _super.call(this, id, width, height, flavour);
        this._initMarkup();
    }
    ...
    DisplayBox.prototype.GetText = function () {
        return this.text;
    };
    DisplayBox.prototype.SetText = function (text) {
        this.text = text;
...
var SelectionBox = (function (_super) {
    ...
    function SelectionBox(id, width, height, flavour, text, options, defaultIndex) {
        _super.call(this, id, width, height, flavour, text);
        this.optionsIndex = 0;
        this.currentIndex = 0;
        if(defaultIndex) {
...
var TypeBox = (function (_super) {
    ...
    function TypeBox(id, flavour, nameBox) {
        _super.call(this, id, 32.15, 16.6, flavour);
    ...
    TypeBox.prototype._initCss = function () {
        this.css.appendChild(document.createTextNode('#' + this.GetId() + ' .content table {' + 'width: 100%;' + 'height: 100%;' + 'padding: .5em 1.5em .5em 1.5em;' + '}' + '#' + this.GetId() + " .content table td {" + 'width: 8.33%;' + '}' + '#' + this.GetId() + ' .content {' + 'position: relative;' + '}' + '#' + this.GetId() + ' .content img {' + 'position: absolute;' + 'top: 1.15em; left: .8em;' + '}'));
    };
    TypeBox.prototype.update = function () {
        ...
        this.css.appendChild(document.createTextNode('#' + this.GetId() + ' .content img {' + 'position: absolute;' + 'top: ' + cursorTopValue + 'em; left:' + cursorLeftValue + 'em;' + '}'));
    };
...
//@ sourceMappingURL=RetroUI.js.map
